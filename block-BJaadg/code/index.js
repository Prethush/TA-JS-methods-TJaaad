...
*/
console.log(quote.charAt(indexOdIs));
/*
...
*/
console.log(from.concat(" and ", quote, " to ", to));
/*
...
console.log(quote.indexOf("o", pos + 1));
/*
13. Find the last index of letter "a" in quote.
*/
  pos = quote.lastIndexOf("a");
 console.log(pos);
/*
14. Find the second last index of letter "a" in quote.
*/

console.log(quote.lastIndexOf("a", pos - 1));
/*
15. Make the quote 70 character long. If it has less characters add rest as .......
Example: "Hello" (convert to 10 characters) => "Hello....."
Store the output in a new variable
*/
let addPaddingEnd = quote.padEnd(70, ".");
console.log(addPaddingEnd);
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
let addPaddingStart = quote.padStart(70, ".");
console.log(addPaddingStart);
/*
